...
For example, Italian condominium software might use portfolio size, resident
message volume, incumbent-suite dependence, building-data readiness, legal-risk
tolerance, and pilot authority. It should not invent `marketing` or `product`
roles that do not describe the market.
